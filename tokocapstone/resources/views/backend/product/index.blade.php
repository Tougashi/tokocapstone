            ...
            @foreach($products as $product)
              ...
              @endphp
                <tr>
                    ...
                    <td>{{$product->title}}</td>
                    <td>{{$product->cat_info['title'] ?? 'No Title'}}
                      <sub>
                    ...
                    <td>
                        <a href="{{route('product.edit',$product->id)}}" class="btn btn-primary btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="ubah" data-placement="bottom"><i class="fas fa-edit"></i></a>
...
@push('scripts')
  ...
  <script>
      ...
      $('#product-dataTable').DataTable({
          "scrollX": false,  // Fixed missing comma
          "columnDefs": [{
              "orderable": false,
              "targets": [7, 8, 9]  // Updated to match actual number of columns (photo, status, action)
          }]
      });
