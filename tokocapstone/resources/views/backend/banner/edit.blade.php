    ...
    <div class="card-body">
      <form method="post" action="{{route('banner.update',$banner->id)}}" enctype="multipart/form-data">
        ...
        <div class="form-group">
          <label for="inputTitle" class="col-form-label">Judul Banner <span class="text-danger">*</span></label>
        ...
        <div class="form-group">
          ...
          @if($banner->photo)
            <div style="margin-top:15px">
              <img src="{{asset($banner->photo)}}" alt="banner image" style="max-width:200px">
            </div>
          @endif
          @error('photo')
          <span class="text-danger">{{$message}}</span>
