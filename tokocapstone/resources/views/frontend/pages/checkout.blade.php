                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-12">
                            <div class="checkout-form">
                                <h2>Lakukan Pembayaran di Sini</h2>
                                <p>Silakan daftar untuk proses pembayaran yang lebih cepat</p>
                                <!-- Form -->
                                <div class="row">
                                            ...
                                            <li class="shipping">
                                                ...
                                                @if(count(Helper::shipping())>0 && Helper::cartCount()>0)
                                                    <select name="shipping" class="nice-select">
                                                        ...
                                                        <option value="{{$shipping->id}}" class="shippingOption" data-price="{{number_format($shipping->price)}}">{{$shipping->type}}: Rp{{number_format($shipping->price)}}</option>
                                                        @endforeach
                                                    </select>
                                                @else
                                                    <span>Gratis</span>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <div class="single-service">
                        <i class="ti-rocket"></i>
                        <h4>Gratis Ongkir</h4>
                        <p>Untuk pembelian di atas $100</p>
                    </div>
                    <!-- End Single Service -->
                </div>
                <div class="col-lg-3 col-md-6 col-12">
            ...
            <div class="inner-top">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2 col-12">
                        ...
                        <div class="inner">
                            <h4>Newsletter</h4>
                            <p>Berlangganan newsletter kami dan dapatkan <span>10%</span> diskon untuk pembelian pertama</p>
	...
	<script>
		$(document).ready(function(){
			$('.shipping select[name=shipping]').change(function(){
				...
				$('#order_total_price span').text('Rp' + formatNumber(subtotal + cost));

                function formatNumber(num) {
                    return num.toFixed(2) // Dua desimal
                            .replace(/\d(?=(\d{3})+\.)/g, '$&,')
                            .replace('.00', '');
                }
