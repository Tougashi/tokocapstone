									...
									@foreach(Helper::getAllProductFromCart() as $key=>$cart)
										<tr>
											...
											<td class="total-amount cart_single_price" data-title="Total">
                                                <span class="money">Rp{{number_format($cart['amount'], 0, ',')}}</span>
                                            </td>
							...
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									<ul>
										...
										<li class="last" id="order_total_price">Total Pembayaran<span>Rp{{number_format(Helper::totalCartPrice())}}</span></li>
									</ul>
									<div class="button5">
