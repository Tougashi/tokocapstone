					...
					<div class="col-12">
						<div class="bread-inner">
							<ul class="bread-list">
								...
								<li class="active"><a href="javascript:void(0);">List Produk</a></li>
							</ul>
						</div>
					</div>
				</div>
						...
						<div class="col-lg-9 col-md-8 col-12">
							...
							<div class="row">
								@if(count($products))
									...
									@endforeach
								@else
                                    <h4 class="text-warning" style="margin:100px auto;">Tidak ada produk tersedia.</h4>
								@endif
							</div>
							 <div class="row">
	...
	<script>
       $(document).ready(function () {
            ...
            if ($("#slider-range").length > 0) {
                ...
                $("#slider-range").slider({
                    ...
                    slide: function (event, ui) {
                        $("#amount").val(
                            currency + formatNumber(ui.values[0]) + " - " + currency + formatNumber(ui.values[1])
                        );
            ...
            if ($("#amount").length > 0) {
                ...
                $("#amount").val(
                    m_currency + formatNumber($("#slider-range").slider("values", 0)) +
                    " - " +
        ...
        function formatNumber(num) {
            return num.toLocaleString('id-ID'); // Menggunakan format Indonesia dengan koma sebagai pemisah ribuan
        }
